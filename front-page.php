...
<div id="swiperContainer" class="swiper-container vertical-slider">
  <div class="swiper-wrapper vertical-slider__wrapper">
    ...
    <div id="verticalSlider05" class="swiper-slide vertical-slider__slide">
      ...
      <picture>
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/top-05-02.webp" media="(min-width:768px)" type="image/webp">
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/top-05-02.jpg" media="(min-width:768px)">
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/top-05-02.webp" type="image/webp">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/top-05-02.jpg" width="1920px" height="2560px" alt="建築事例01" class="vertical-slider-img">
      </picture>
      <div class="progress-container">
        <div class="progress-bar"></div>
        </div>
